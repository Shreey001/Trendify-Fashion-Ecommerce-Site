        ...
        <div className="relative">
          ...
          <div className="relative flex items-center justify-between py-4 px-4 sm:px-6 lg:px-8">
            ...
            >
              <img
                src={assets.logo}
                className="w-35 h-12 sm:w-50 sm:h-18 drop-shadow-sm"
                alt=""
              />
            </Link>
            ...
            <ul className="hidden sm:flex gap-8 text-sm font-medium text-gray-700">
              ...
              >
                <p className="relative px-2 py-1 rounded-full hover:bg-white/50 transition-all duration-300">
                  HOME
                  <span
                    className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-pink-500 to-purple-500 
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="profile-dropdown-container relative z-50">
                <button
                  className="p-2 hover:bg-pink-300 rounded-full transition-all duration-300"
                    ...
                    <div className="relative pt-2">
                      ...
                      <div className="relative bg-white/90 backdrop-blur-lg shadow-lg rounded-xl border border-white/20">
                        <div className="flex flex-col gap-2 w-32 py-3 px-5">
                          <Link
                            to="/profile"
                            className="cursor-pointer hover:text-pink-500 transition-colors duration-200 whitespace-nowrap"
              ...
              >
                <img
                  ...
                  className="w-5  min-w-5 hover:opacity-70 transition-opacity duration-300"
                  alt=""
                />
                {getCartCount() > 0 && (
            ...
            >
              <div
                className={`absolute top-0 right-0 bottom-0 w-64 bg-white shadow-xl 
              ...
              >
                <div className="flex flex-col text-gray-600">
                  ...
                  <NavLink
                    onClick={() => setVisible(false)}
                    to="/"
                    className="py-4 px-6 border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200"
                  >
                    <p>HOME</p>
                  </NavLink>
