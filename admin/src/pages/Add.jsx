  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='w-full'>
        ...
        <textarea onChange={(e) => setDescription(e.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2' type='text' placeholder='Enter details' required />
      </div>
      ...
      <div>
        ...
        <div className='flex gap-3'>
          ...
          <div onClick={
            ...
            <p
              className={`${sizes.includes("S") ? "bg-pink-100" : "bg-slate-200"} px-3 py-2 cursor-pointer`}
            >S</p>
          </div>
          <div
            onClick={
